...
case class SwitchConfig(id : Long, switchType : String, switchDelay : Int, isConnected : Boolean, upstreamConnections : List[Connection], downstreamConnections : List[Connection])